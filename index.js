...
const uri = "mongodb+srv://sanjayjs:Sanjujs@cluster0.hxa9h.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 });
        ...
        client.connect(function(err) {
          try
          {
                ...
                collection.insertOne({name:n, age:a, mobile:m, email:e}, function(err, resp){
                if (err)
                {
